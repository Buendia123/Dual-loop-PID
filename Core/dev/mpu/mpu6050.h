...
extern uint16_t Gx_offset,Gy_offset,Gz_offset;
...
void MPU6050_getlastMotion6(uint16_t* ax, uint16_t* ay, uint16_t* az, uint16_t* gx, uint16_t* gy, uint16_t* gz);
uint8_t MPU6050_getDeviceID(void);
void MPU6050_InitGyro_Offset(void);
void DMP_Init(void);
//void Read_DMP((pose_angle*) angle);
